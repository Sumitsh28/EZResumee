...
import { fadeInOut, scaleInOut } from "../animations";
      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className="px-3 py-2 rounded-md bg-gray-200 absolute -left-52 after:w-2 after:h-2 after:bg-gray-200 after:absolute after:-right-1 after:top-[14px] after:rotate-45"
          >
